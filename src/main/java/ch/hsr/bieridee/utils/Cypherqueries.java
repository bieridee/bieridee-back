...
public final class Cypherqueries {
	...
	// Rating
	public static final String GET_AVERAGE_RATING_OF_BEER = "START START_BEER = node($$) MATCH START_BEER<-[:CONTAINS]-Action WHERE Action.type = '" + NodeType.RATING + "' RETURN SUM(Action." + NodeProperty.Rating.RATING + ")/COUNT(*) AS AverageRating";
