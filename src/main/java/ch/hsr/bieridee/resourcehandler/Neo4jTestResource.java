...
public class Neo4jTestResource extends ServerResource {
	...
	private Node beer1, beer2, user1, beerIndex;
	...
	private void createData() {
		...
		try {
			...
			//Creating an Index Node and attach the beer Nodes to it.
			beerIndex = graphDb.createNode();
			beerIndex.createRelationshipTo(graphDb.getReferenceNode(),
					RelTypes.INDEXES);	
			beer1.createRelationshipTo(beerIndex, RelTypes.INDEXES);
			beer2.createRelationshipTo(beerIndex, RelTypes.INDEXES);
